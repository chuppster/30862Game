...
*/									//did not originally extend KeyAdapter, it implemented KeyListener isntead
    ...
    MouseMotionListener, MouseWheelListener
{
    ...
    */
    public InputManager(Component comp) {
        ...
        //THESE 4 LINES ARE IMPORTANT!!!! - setVisible -> false -> true is required to make it work on mac.....
        //got lucky and found that on the internet....Rest just guantees it's working
        comp.setVisible(false);
        comp.setVisible(true);
        comp.setFocusable(true);
        comp.requestFocusInWindow();
        
        System.out.println("isFocusable = " + comp.isFocusable());
...
//    	System.out.println(" key typed    in keyTyped inside InputManager class");
    ...
    public void mouseClicked(MouseEvent e) {
        // do nothing
    	System.out.println("mouseClicked event in Input Manager");
    }
    ...
    public void mouseWheelMoved(MouseWheelEvent e) {
        System.out.println("mouseWheelMoved event in Input Manager");
